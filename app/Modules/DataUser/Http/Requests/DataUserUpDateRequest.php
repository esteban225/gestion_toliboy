...
/**
 * UpDateRequest gestiona la validación de datos para el registro de usuarios.
 *
...
class DataUserUpDateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'num_phone' => 'sometimes|nullable|string|max:20',
            'num_phone_alt' => 'sometimes|nullable|string|max:20',
            // 'personal_data' is likely a typo, it should be 'personal_data'
            'num_identification' => 'sometimes|required|string|max:50',
            'identification_type' => 'sometimes|required|string|max:45',
            'address' => 'sometimes|nullable|string|max:45',
            'emergency_contact' => 'sometimes|required|string|max:100',
            'emergency_phone' => 'sometimes|required|string|max:25',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'num_identification.unique' => 'El número de identificación ya está en registrado.',
