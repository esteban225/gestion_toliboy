...
-- -----------------------------------------------------
-- View `toliboy`.`form_response_details`
-- -----------------------------------------------------
CREATE OR REPLACE VIEW `toliboy`.`form_response_details` AS
SELECT
    fr.id as response_id,
    f.name as form_name,
    f.version as form_version,
...
-- -----------------------------------------------------
-- View `toliboy`.`user_work_summary`
-- -----------------------------------------------------
CREATE OR REPLACE VIEW `toliboy`.`user_work_summary` AS
SELECT
    user_id,
    u.name as user_name,
...
-- -----------------------------------------------------
-- View `toliboy`.`v_current_stock`
-- -----------------------------------------------------
CREATE OR REPLACE VIEW `toliboy`.`v_current_stock` AS
SELECT
    rm.id AS raw_material_id,
    rm.name,
    rm.code,
